...
function Pages() {
    ...
    return (
        <Switch>
            ...
            <Route path="/register" component={isLogged ? NotFound : Resgister} exact />
            <Route path="/create_product" component={isAdmin ? CreateProduct : NotFound} exact />
            <Route path="/edit_product/:id" component={isAdmin ? CreateProduct : NotFound} exact />
