...
const initialState = {
  ...
  price: 0,
  description: "",
  content: "Welcome !!! The best brand ever! ",
  category: '',
  _id: ''
};
  ...
  const handleUpload = async e =>{
    ...
    try {
      ...
      if(file.size > 1024 * 1024)
        return  setAlert('Size too large!')
      ...
      <div id="ad_create_product">
          ...
          <form  onSubmit={saveProduct}>
            ...
            <div className="row">
              ...
              <textarea type="text" name="content" rows="7" id="content"
            ...
            <div className="row">
                ...
                <select style={{minWidth: '150px', textTransform: "capitalize"}}
                name="category" value={product.category}  onChange={handleChangeInput} required >
